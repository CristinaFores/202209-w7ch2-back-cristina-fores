...
describe(" Given a deleteRobotById a controllers", () => {
  describe("Whend it receives a request token resonse one deleted robot id with findByIdAndDelete ", () => {
...
describe("Given a editRobotById a controller", () => {
  ...
  // Describe("when it receives a token 'patatasfritas' and correct id", () => {
